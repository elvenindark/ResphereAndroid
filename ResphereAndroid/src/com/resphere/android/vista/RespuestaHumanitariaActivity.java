...
public class RespuestaHumanitariaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_respuesta_humanitaria);
		
		preferencias = new ConfiguracionPreferencias(this);
		titles = getResources().getStringArray(R.array.RespuestaHumanitaria);
		descriptions = getResources().getStringArray(R.array.RespuestaHumanitariaDescriptions);
		preferencias = new ConfiguracionPreferencias(this);		
		CustomList adapter = new CustomList(RespuestaHumanitariaActivity.this, titles, descriptions, images);
        listView=(ListView)findViewById(R.id.listRespuesta);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_respuesta_humanitaria, menu);
		return true;
	}
