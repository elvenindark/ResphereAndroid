...
public class RespuestaHumanitariaDetalleActivity extends Activity {
	...
	public void init(){
		txtIndicador = (TextView)this.findViewById(R.id.textIndicador);
		btnEnviarRespuesta = (Button)this.findViewById(R.id.btnEnviarRespuesta);
		btnGuardarRepuesta = (Button)this.findViewById(R.id.btnGuardarRespuesta);
		editObservaciones = (EditText)this.findViewById(R.id.editObservacionRespuesta);
		radioRespuesta = (RadioGroup)this.findViewById(R.id.radioGroupRespuesta);
		txtObservaciones = (TextView)this.findViewById(R.id.txtObservacionR);
	}
